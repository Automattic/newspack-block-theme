...
To report a bug, please [open a new issue](https://github.com/Automattic/newspack-block-theme/issues/new?template=Bug_report.md). In order for us to better understand and reproduce the bug, please include as much of the following information as possible:
...
Feature requests can be [submitted to our issue tracker](https://github.com/Automattic/newspack-block-theme/issues/new?template=Feature_request.md). Be sure to include a description of the expected behavior and use case, and before submitting a request, please search for similar ones in the closed issues.

## Pull requests

To submit a patch to the Newspack block theme, simply create a pull request to the master branch of the Newspack block theme repository. Please test and provide an explanation for your changes. When opening a pull request, please follow these guidelines:
