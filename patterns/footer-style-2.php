...
<div class="wp-block-group alignwide"><!-- wp:group {"lock":{"move":true,"remove":true},"metadata":{"name":"<?php esc_html_e( 'Content', 'newspack-block-theme' ); ?>"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|50"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
<div class="wp-block-group"><!-- wp:social-links {"iconColor":"base","iconColorValue":"#ffffff","iconBackgroundColor":"contrast-2","className":"has-icon-background-color"} -->
...
<p class="has-small-font-size"><?php esc_html_e( 'Our online newspaper delivers the latest news and insightful analysis.', 'newspack-block-theme' ); ?><br><?php esc_html_e( 'Our experienced journalists ensure accurate and impartial reporting.', 'newspack-block-theme' ); ?><br><?php esc_html_e( 'Stay informed with our engaging and informative articles.', 'newspack-block-theme' ); ?></p>
<!-- /wp:paragraph -->
